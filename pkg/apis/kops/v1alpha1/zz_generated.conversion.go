...
func RegisterConversions(scheme *runtime.Scheme) error {
	return scheme.AddGeneratedConversionFuncs(
		Convert_v1alpha1_AcceleratorConfig_To_kops_AcceleratorConfig,
		Convert_kops_AcceleratorConfig_To_v1alpha1_AcceleratorConfig,
...
func autoConvert_v1alpha1_AcceleratorConfig_To_kops_AcceleratorConfig(in *AcceleratorConfig, out *kops.AcceleratorConfig, s conversion.Scope) error {
	out.AcceleratorCount = in.AcceleratorCount
	out.AcceleratorType = in.AcceleratorType
	out.ForceSendFields = in.ForceSendFields
	out.NullFields = in.NullFields
	return nil
}

// Convert_v1alpha1_AcceleratorConfig_To_kops_AcceleratorConfig is an autogenerated conversion function.
func Convert_v1alpha1_AcceleratorConfig_To_kops_AcceleratorConfig(in *AcceleratorConfig, out *kops.AcceleratorConfig, s conversion.Scope) error {
	return autoConvert_v1alpha1_AcceleratorConfig_To_kops_AcceleratorConfig(in, out, s)
}

func autoConvert_kops_AcceleratorConfig_To_v1alpha1_AcceleratorConfig(in *kops.AcceleratorConfig, out *AcceleratorConfig, s conversion.Scope) error {
	out.AcceleratorCount = in.AcceleratorCount
	out.AcceleratorType = in.AcceleratorType
	out.ForceSendFields = in.ForceSendFields
	out.NullFields = in.NullFields
...
// Convert_kops_AcceleratorConfig_To_v1alpha1_AcceleratorConfig is an autogenerated conversion function.
func Convert_kops_AcceleratorConfig_To_v1alpha1_AcceleratorConfig(in *kops.AcceleratorConfig, out *AcceleratorConfig, s conversion.Scope) error {
	return autoConvert_kops_AcceleratorConfig_To_v1alpha1_AcceleratorConfig(in, out, s)
}
