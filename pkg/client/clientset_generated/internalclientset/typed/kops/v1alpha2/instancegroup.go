...
func (c *instanceGroups) Create(instanceGroup *v1alpha2.InstanceGroup) (result *v1alpha2.InstanceGroup, err error) {
	fmt.Printf("Internal Client Set Alpha 2 %v\n", c)
	fmt.Printf("Internal Client Set Alpha 2.1 %v\n", instanceGroup)
	result = &v1alpha2.InstanceGroup{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("instancegroups").
		...
		Do().
		Into(result)
	fmt.Printf("Internal Client Set Alpha 2.2 %v\n", err)
  fmt.Printf("Internal Client Set Alpha 2.3 %v\n", result)
	return
}
