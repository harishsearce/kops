...
func (c *instanceGroups) Create(instanceGroup *v1alpha1.InstanceGroup) (result *v1alpha1.InstanceGroup, err error) {
	fmt.Printf("Internal Client Set Alpha 1 %v\n", c)
	fmt.Printf("Internal Client Set Alpha 1.1 %v\n", instanceGroup)
	result = &v1alpha1.InstanceGroup{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("instancegroups").
		...
		Do().
		Into(result)
	fmt.Printf("Internal Client Set Alpha 1.2 %v\n", err)
	fmt.Printf("Internal Client Set Alpha 1.3 %v\n", result)
	return
}
