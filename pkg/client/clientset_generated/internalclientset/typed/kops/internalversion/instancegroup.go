...
func (c *instanceGroups) Create(instanceGroup *kops.InstanceGroup) (result *kops.InstanceGroup, err error) {
	fmt.Printf("Internal Client Set Internal 1 %v\n", c)
	fmt.Printf("Internal Client Set Internal 1.1 %v\n", instanceGroup)
	result = &kops.InstanceGroup{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("instancegroups").
		...
		Do().
		Into(result)
	fmt.Printf("Internal Client Set Internal 1.2 %v\n", err)
	fmt.Printf("Internal Client Set Internal 1.3 %v\n", result)
	return
}
